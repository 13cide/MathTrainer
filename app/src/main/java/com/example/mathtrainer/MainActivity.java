...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.next.setOnClickListener(cl);
        binding.solution1.setOnClickListener(cl);
        binding.solution2.setOnClickListener(cl);
        binding.solution3.setOnClickListener(cl);
    }
